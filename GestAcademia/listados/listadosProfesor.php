...
$alumnos = $model->getProfesores('all'); // Asegúrate de que este método ejecute: SELECT * FROM Alumno
...
$pdf->SetSubject('Listado de profesores');
...
if (!empty($alumnos)) {
    ...
    $pdf->Cell(0, 10, "No se encontraron profesores.", 0, 1, 'L');
}

// Salida del PDF: "I" para mostrar en el navegador
$pdf->Output('ListadoProfesor.pdf', 'I');
?>
