...
$query = $conn->prepare("SELECT ID_Profesor, Nombre, Apellido1, Apellido2 FROM profesor WHERE Nombre LIKE ? OR Apellido1 LIKE ? OR Apellido2 LIKE ? OR ID_Profesor LIKE ?");
