...
<head>
    ...
    <title>Listado Matriculaciónes de Alumnos</title>
...
<body class="bg-light">
    <!-- Sidebar -->
    <div class="sidebar">
        <h2>Listado de alumnos matriculados por pantalla</h2>
        <ul>
            <li><a href="../../mainpage.php"><i class="fas fa-home"></i> Inicio</a></li>
            <li>
                <a href="/mainpage.php?route=createMatricula"><i class="fas fa-clipboard-list"></i> Volver a
                    Matrículas</a>

            </li>
            <li>
                <!-- Enlace para modificar matriculas -->
                <a href="/mainpage.php?route=bajaAlumnos"><i class="fas fa-user-minus"></i> Listar alumnos
                    Matriculados</a>
            </li>
    ...
    <div class="content">
        <div class="header">
            <h1>Listado de Matriculas por curso</h1>
        </div>
        <?php
        ...
        <div class="container mt-5">
            <h2 class="mb-4 text-center">Lista de matriculas de Alumnos</h2>
            <div class="card p-4 shadow">
                <form id="AlumnosForm">
                    ...
                    <div id="alumnoslistaContainer" class="container mt-3 d-none">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="alumnoslistaTableBody">
        ...
        <script src="/../../js/alumnoscurso.js"></script>
</body>
